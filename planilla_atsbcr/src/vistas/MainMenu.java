...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuMaesEmpl = new javax.swing.JMenu();
        ...
        MainMenu.setPreferredSize(new java.awt.Dimension(34, 30));

        jMenuMaesEmpl.setText("File");
        ...
        jMenuItem2.setText("Maestro Empleados");
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem2ActionPerformed(evt);
            }
        });
        jMenuMaesEmpl.add(jMenuItem2);

        jMenu3.setText("Generar Planilla");
        ...
        jMenuItem4.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Q, java.awt.event.InputEvent.SHIFT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        jMenuItem4.setText("Quincenal");
        jMenu3.add(jMenuItem4);

        jMenuMaesEmpl.add(jMenu3);
        ...
        jMenuMaesEmpl.add(jMenuSalir);

        MainMenu.add(jMenuMaesEmpl);
    ...
    private javax.swing.JMenu jMenuMaesEmpl;
